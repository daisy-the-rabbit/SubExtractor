...
public partial class CharacterSelector : UserControl
{
    ...
    SolidBrush textBrush = new SolidBrush(SystemColors.WindowText);
    SolidBrush selectedCellBrush;
    SolidBrush hoveredCellBrush;
    Font font;
    Font fontItalics;
    Font fontSpecial;
    Font fontSpecialItalics;
    bool isItalics;
    ...
    static readonly int LineLength = AllCharacters.Max(s => s.Length);
    ...
    public CharacterSelector()
    {
        ...
        this.selectedCellBrush = new SolidBrush(isDark ? Color.DimGray : Color.LightGray);
        this.hoveredCellBrush = new SolidBrush(isDark ? Color.DimGray : Color.LightGray);
    ...
    void CreateFonts()
    {
        ...
        fontItalics?.Dispose();
        fontSpecial?.Dispose();
        fontSpecialItalics?.Dispose();

        font = DpiHelper.CreateScaledFont("Tahoma", 14.0f, FontStyle.Regular, dpi);
        fontItalics = DpiHelper.CreateScaledFont("Tahoma", 14.0f, FontStyle.Italic, dpi);
        fontSpecial = DpiHelper.CreateScaledFont("Arial", 14.0f, FontStyle.Regular, dpi);
        fontSpecialItalics = DpiHelper.CreateScaledFont("Arial", 14.0f, FontStyle.Italic, dpi);
    }
