...
public class SubConstants
{
    ...
    public static readonly char[] MovieSpecificChars =
        ['1', 'l', 'I', 'Ι', '.', '\'', ',', '-', '—', '_', '\\', '/', '|', '+',
          'o', 'O', '°', 'ฺ', '่', '๋', 'ํ', 'Ο', 'ο', '"', OcrCharacter.UnmatchedValue];
    public static readonly char[] MovieSpecificSpanishChars = ['i', '¡', 'ί'];
    ...
    public const string DiacriticCharacters = "ัิีึืฺุู็่้๊๋์ํ๎";
    public const string UntrustedForBaselineCharacters = "\'\".,-—_=:;°„าโใไๅๆฦฤฟปฝУдф" + DiacriticCharacters;
    public const string DiacriticLowCharacters = "ฺุู";
    ...
    public static Font CreateLargeFormFont(float deviceDpi)
    {
        return DpiHelper.CreateScaledFont("Segoe UI", 11F, FontStyle.Regular, deviceDpi);
    }

    public static Font CreateLargeHelpFont(float deviceDpi)
    {
        return DpiHelper.CreateScaledFont("Segoe UI", 16F, FontStyle.Regular, deviceDpi);
    }

    public static Font CreateLargeMainToolStripFont(float deviceDpi)
    {
        return DpiHelper.CreateScaledFont("Segoe UI", 12F, FontStyle.Bold, deviceDpi);
    }
}
