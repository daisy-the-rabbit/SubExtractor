...
public class CreateSrtFile
{
    ...
    static string CreateSrtTime(double pts, double duration)
    {
        ...
        return $"{timeStart.Hours:d2}:{timeStart.Minutes:d2}:{timeStart.Seconds:d2},{timeStart.Milliseconds:d3} --> {timeEnd.Hours:d2}:{timeEnd.Minutes:d2}:{timeEnd.Seconds:d2},{timeEnd.Milliseconds:d3}\r\n";
    }
