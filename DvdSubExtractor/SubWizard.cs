...
public partial class SubWizard : Form
{
    ...
    static Type[] stepTypes = [typeof(LoadFolderStep),
    ...
    static Type[] subtitleOptionTypes = [typeof(CreateSubtitleFileStep)];
    static Type[] subdialogTypes = [typeof(WordSpacingStep)];
    ...
    public SubWizard()
    {
        ...
        if(!Properties.Settings.Default.ShowHelpText)
        {
            ...
            int widthReduction = this.ClientSize.Width - newClientWidth;
            this.panelItem.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
        ...
        if(Properties.Settings.Default.LargeMode)
        {
            ...
            this.mainToolStrip.Font = SubConstants.CreateLargeMainToolStripFont(this.DeviceDpi);
        }
