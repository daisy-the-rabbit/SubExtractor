...
public partial class OptionsForm : Form
{
    ...
    string pendingTheme;
    string pendingDpiScale;
    bool pendingShowHelpText;

    public OptionsForm()
    {
        InitializeComponent();

        this.pendingTheme = ThemeManager.NormalizeTheme(Properties.Settings.Default.Theme);
        this.themeComboBox.SelectedItem = this.pendingTheme;

        this.pendingShowHelpText = Properties.Settings.Default.ShowHelpText;
        this.showHelpTextCheckBox.Checked = this.pendingShowHelpText;

        this.pendingDpiScale = Properties.Settings.Default.DpiScale ?? "PerMonitorV2";
        this.scaleComboBox.SelectedIndex = this.pendingDpiScale switch
        {
            "System" => 1,
            "Unaware" => 2,
            _ => 0,
    ...
    void UpdateFontName()
    {
        ...
        {
            this.fontFamilyLabel.Text = $"{this.fontFamilyName} {this.fontSize:f0}";
        }
    }
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
        ...
        this.pendingShowHelpText = this.showHelpTextCheckBox.Checked;
        bool previousShowHelpText = Properties.Settings.Default.ShowHelpText;
        Properties.Settings.Default.ShowHelpText = this.pendingShowHelpText;
        string previousTheme = Properties.Settings.Default.Theme;
        Properties.Settings.Default.Theme = this.pendingTheme;
        string previousDpiScale = Properties.Settings.Default.DpiScale;
        Properties.Settings.Default.DpiScale = this.pendingDpiScale;
    ...
    private void themeComboBox_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        this.pendingTheme = ThemeManager.NormalizeTheme(selectedTheme);
    }

    private void scaleComboBox_SelectedIndexChanged(object sender, EventArgs e)
    {
        this.pendingDpiScale = this.scaleComboBox.SelectedIndex switch
        {
            1 => "System",
            2 => "Unaware",
            _ => "PerMonitorV2",
