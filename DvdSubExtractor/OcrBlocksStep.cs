...
public partial class OcrBlocksStep : UserControl, IWizardItem
{
    ...
    List<Control> controlsToDisableDuringSplit = [];
    int subtitleIndex;
    List<SubtitleData> allData = [];
    ...
    List<BlockEncode> selectedEncodes = [];
    ...
    public OcrBlocksStep()
    {
        ...
        if (isDark)
        {
            Color accent = Color.LightSkyBlue;
            this.triangleFill1.ForeColor = accent;
            this.triangleFill2.ForeColor = accent;
            this.triangleFill3.ForeColor = accent;
            this.triangleFill4.ForeColor = accent;
        }
    ...
    public void Initialize(ExtractData data)
    {
        ...
        this.controlsToDisableDuringSplit.AddRange([
        ...
        this.data.NewStepInitialize(false, true, "", [typeof(LoadFolderStep)]);
    ...
    void LoadCurrentSubtitleData()
    {
        ...
        this.subtitleIndexLabel.Text = $"Subtitle {this.subtitleIndex + 1} of {this.allData.Count}";
                                            ...
                                            !((char2 == 'r') && ((char1 == 'n') || (char1 == 'ñ') || (char1 == 'ń'))))
                                        {
                                            ...
                                            if ((encodes1.Count == 1) && (encodes2.Count == 1))
                                            {
                                                this.ocrMap.AddSplit(this.unmatchedEncode.FullEncode,
                                                    ...
                                                    this.movieId);
                                                Debug.WriteLine($"Found Perfect Split {result.Entry1.OcrCharacter.Value} & {result.Entry2.OcrCharacter.Value}");
    ...
    private void paletteIndexLabel_Click(object sender, EventArgs e)
    {
