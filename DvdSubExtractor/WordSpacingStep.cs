...
public partial class WordSpacingStep : UserControl, IWizardItem
{
    ...
    public WordSpacingStep()
    {
        ...
        this.label6.ForeColor = accent;
        this.defaultItalicRightLabel.ForeColor = accent;
        this.defaultItalicLeftLabel.ForeColor = accent;
        this.defaultRightLabel.ForeColor = accent;
        this.defaultLeftLabel.ForeColor = accent;
    ...
    void FillListWithSpellings(char c, bool italic)
    {
        ...
        int charWidth = TextRenderer.MeasureText("MMMMMMMMMM", correctFont).Width - TextRenderer.MeasureText("MMMMM", correctFont).Width;
