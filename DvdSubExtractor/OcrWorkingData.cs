...
public class OcrWorkingData : IDisposable
{
    ...
    List<ISubtitleData> streamSubtitles = [];
    ...
    public void CompileSubtitleLines()
    {
        ...
        float windowsToDvdFontHeightConversion = this.VideoAttributes.AspectRatio switch
        {
            VideoAspectRatio._4by3 => SubConstants.WindowsToDvd4x3FontHeightConversion,
            _ => SubConstants.WindowsToDvdFontHeightConversion,
        };
