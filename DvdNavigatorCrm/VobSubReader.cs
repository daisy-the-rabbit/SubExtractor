...
public class VobSubReader : IDisposable
{
    ...
    byte[] ReadPacket(ref int subStreamId)
    {
        ...
        if (startPack[3] == MpegPSSplitter.PaddingStreamCode)
        {
            ...
            int paddingLength = BinaryPrimitives.ReadUInt16BigEndian(paddingHeader);
        ...
        int packetLength = BinaryPrimitives.ReadUInt16BigEndian(pesHeader) - 3 - pesHeaderLength - 1;
