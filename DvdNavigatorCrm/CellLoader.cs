...
public class CellLoader : IBasicSplitterCallback
{
    ...
    List<PacketBuffer> packets = [];
    List<PacketBuffer> savedPackets = [];
    List<CellIdVobId> vobCellIds = [];
    List<CellIdVobId> angleCellIds = [];
    ...
    {
        BytesRead?.Invoke(this, new LoadedBytesEventArgs(byteCount));
    }
    ...
    {
        this.SplitterTrace?.Invoke(this, new TraceEventArgs(text));
    }
