...
public class OpCode
{
    ...
    public override string ToString()
    {
        ...
        {
            sb.Append($"GP{this.DestRegister} ");
        }
        ...
        if (this.PGCN != 0)
        {
            sb.Append($"PGCN {this.PGCN} ");
        }
        if (this.PTTN != 0)
        {
            sb.Append($"PTTN {this.PTTN} ");
        }
        if (this.PGN != 0)
        {
            sb.Append($"PGN {this.PGN} ");
        }
        if (this.CN != 0)
        {
        ...
        if (this.TTN != 0)
        {
            sb.Append($"TTN {this.TTN} ");
        }
        if (this.VTS != 0)
        {
            sb.Append($"VTS {this.VTS} ");
        }
        if (this.RsmCell != 0)
        {
            sb.Append($"RsmCell {this.RsmCell} ");
        }
        if (this.Menu != 0)
        {
        ...
        {
            sb.Append($"SSType {this.SSType} ");
        }
        if (this.LinkSubset != OpLinkSubset.None)
        {
            sb.Append($"LinkSubset {this.LinkSubset} ");
        }
